      ...
      <div className="w-full lg:w-1/2 bg-[#100F1D] lg:rounded-l-[3rem] py-55 px-45">
        ...
        <form className="space-y-5">
          <div className="space-y-2">
            <label className="text-gray-300 text-base ml-1">Correo :</label>
          ...
          <div className="space-y-2">
            <label className="text-gray-300 text-base ml-1">Contraseña:</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-3 flex items-center text-gray-400">
                <Lock size={18} />
              </span>
          ...
          <p className="text-center text-base text-gray-400 mt-4">
            ...
            <Link href="/register" className="px-2 text-base text-blue-600 transition-colors ">
              Registrate
            </Link>
          </p>
        </form>
